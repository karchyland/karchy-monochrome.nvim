...
local groups = {
  ...
  PmenuKindSel = { fg = c.blue, bg = c.selection },
  ...
  DiagnosticVirtualTextHint = { fg = c.accent, bg = c.bg_dark },
  ...
  DiagnosticUnderlineHint = { sp = c.accent, undercurl = true },
  ...
  ["@lsp.type.namespace"] = { fg = c.violet },
  ...
  ["@module"] = { fg = c.violet },
  ["@module.builtin"] = { fg = c.violet, italic = true },
  ["@label"] = { link = "Label" },
  ["@string"] = { link = "String" },
